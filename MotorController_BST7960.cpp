...
//    if(set_PWM_range(gpioHostHandle, pwm1UpPin, 255) < 0) {
//        qDebug() << QString("Unable to set PWM range for Motor 1Up.");
//        exit(EXIT_FAILURE);
//    }
//    int32_t realRange = get_PWM_real_range(gpioHostHandle, pwm1UpPin);
//    if(set_PWM_range(gpioHostHandle, pwm1LowPin, 255) < 0) {
//        qDebug() << QString("Unable to set PWM range for Motor 1Low.");
//        exit(EXIT_FAILURE);
//    }
...
//    if(set_PWM_range(gpioHostHandle, pwm2UpPin, 255) < 0) {
//        qDebug() << QString("Unable to set PWM range for Motor 2Up.");
//        exit(EXIT_FAILURE);
//    }
//    int32_t realRange = get_PWM_real_range(gpioHostHandle, pwm2UpPin);
//    if(set_PWM_range(gpioHostHandle, pwm2LowPin, 255) < 0) {
//        qDebug() << QString("Unable to set PWM range for Motor 2Low.");
//        exit(EXIT_FAILURE);
//    }
